                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: truck.address != null
                                ...
                                SizedBox(
                                  ...
                                  child: FlatButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      // Geocode address
                                      var addresses = await Geocoder.local.findAddressesFromQuery(truck.address);
                                      double latitude = addresses.first.coordinates.latitude;
                                      double longitude = addresses.first.coordinates.longitude;
                          ...
                          : Text(
                              "No address currently available.",
                            ),
                    ),
                    Container(
                      width: MediaQuery.of(context).size.width,
