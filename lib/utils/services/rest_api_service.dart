...
class APIService {
  ...
  static Future<Map<String, dynamic>> fetchAnnouncements() async {
    return await _get('${ApiPath.BASE_API_URL}/announcements/');
  }
...
//  static Future<String> fetchAnnouncementPage() {}
  ...
  static Future<Map<String, dynamic>> fetchNotifications() async {
    return await _get('${ApiPath.BASE_API_URL}/notifications/');
  }
  ...
  static Future<Map<String, dynamic>> fetchEvents() async {
    return await _get('${ApiPath.BASE_API_URL}/events/');
  }
  ...
  static Future<Map<String, dynamic>> fetchCaters() async {
    return await _get('${ApiPath.BASE_API_URL}/caters/');
  }

  static Future<Map<String, dynamic>> fetchCaterRequestsByTruckID(int truckID) async {
    return await _get('${ApiPath.BASE_API_URL}/caters?search=$truckID');
  }
  ...
  static Future<Map<String, dynamic>> fetchDashboard() async {
    return await _get('${ApiPath.BASE_API_URL}/dashboard/');
  }

  static Future<Map<String, dynamic>> fetchDashboardDetail(int truckID) async {
    return await _get('${ApiPath.BASE_API_URL}/dashboard/$truckID/');
  }
  ...
  static Future<List<dynamic>> fetchRecentTrucks() async {
    return await _get('${ApiPath.BASE_API_URL}/trucks/recent/');
  }

  static Future<List<dynamic>> fetchFavoriteTrucks() async {
    return await _get('${ApiPath.BASE_API_URL}/trucks/favorites/');
  }

  static Future<Map<String, dynamic>> fetchTrucksListByLocation(double lat, double lng) async {
    return await _get('${ApiPath.BASE_API_URL}/trucks/?geolocation=${lat.toString().trim()},${lng.toString().trim()}');
  }
  ...
  static Future<dynamic> patchLive(Truck truck, {String endTime}) async {
    ...
    var response = await dio.patch(
      '${ApiPath.BASE_API_URL}/trucks/${truck.pk}/live',
      data: formData,
      options: Options(
  ...
  static Future<dynamic> postLive(Truck truck, {String endTime}) async {
    ...
    e.putIfAbsent('end_time', () => endTime);
    FormData formData = FormData.fromMap(e);
    var resp = await dio.post('${ApiPath.BASE_API_URL}/lives/',
        data: formData,
        options: Options(
            followRedirects: false,
            validateStatus: (status) {
...
//    FormData formData = FormData.fromMap(body);
    ...
    Response response = await dio.patch(
      '${ApiPath.BASE_API_URL}/trucks/$pk/',
      options: Options(
        headers: headers,
        followRedirects: false,
        validateStatus: (status) {
  ...
  static Future<Response> deleteTruckEvent(int eventID) async {
    return await _delete('${ApiPath.BASE_API_URL}/schedules/$eventID/');
  }
  ...
  static Future<Map<String, dynamic>> fetchTag(String tag) async {
    return await _get('${ApiPath.BASE_API_URL}/tags/?title=$tag');
  }

  static Future<Map<String, dynamic>> fetchTags() async {
    return await _get('${ApiPath.BASE_API_URL}/tags/');
  }

  static Future<Map<String, dynamic>> fetchFeaturedTags() async {
    return await _get('${ApiPath.BASE_API_URL}/tags/?featured=True');
  }
  ...
  static Future<Map<String, dynamic>> fetchReviews() async {
    return await _get('${ApiPath.BASE_API_URL}/reviews/');
  }

  static Future<Map<String, dynamic>> fetchReviewsByReviewId(int pk) async {
    return await _get('${ApiPath.BASE_API_URL}/reviews/$pk/');
  }

  static Future<Map<String, dynamic>> fetchReviewsByUserId(int id) async {
    return await _get('${ApiPath.BASE_API_URL}/reviews/?user=$id');
  }

  static Future<Map<String, dynamic>> fetchReviewsByTruckId(int id) async {
    return await _get('${ApiPath.BASE_API_URL}/reviews/?truck=$id');
  }
  ...
  static Future<void> deleteReview(int reviewID) async {
    ...
    await dio.delete(
      '${ApiPath.BASE_API_URL}/reviews/$reviewID/',
      options: Options(
        headers: headers,
        followRedirects: false,
        validateStatus: (status) {
  ...
  static Future<List<dynamic>> fetchMenuByTruck(pk) async {
    var data;
    var response = await _get('${ApiPath.BASE_API_URL}/trucks/$pk/');
  ...
  static Future<Map<String, dynamic>> patchMenuItem(MenuItem menuItem) async {
    ...
    FormData formData = FormData.fromMap(e);
    var response = await dio.patch(
      '${ApiPath.BASE_API_URL}/menu-items/${menuItem.pk}/',
      data: formData,
      options: Options(
        followRedirects: false,
        validateStatus: (status) {
  ...
  static Future<Map<String, dynamic>> postMenuItem(Truck truck, MenuItem menuItem) async {
    ...
    var response = await dio.post(
      '${ApiPath.BASE_API_URL}/menu-items/?truck=${truck.pk}',
      data: formData,
      options: Options(
        followRedirects: false,
        validateStatus: (status) {
  ...
  static Future<bool> deleteMenuItem(int menuItemID) async {
    var resp = await _delete('${ApiPath.BASE_API_URL}/menu-items/$menuItemID/');
...
/* MAILING LIST*/
  ...
  static Future<Map<String, dynamic>> patchNotification(int id, {bool seen}) async {
    ...
    var response = await dio.patch(
      '${ApiPath.BASE_API_URL}/notifications/$id/',
      data: formData,
      options: Options(
        headers: headers,
        followRedirects: false,
